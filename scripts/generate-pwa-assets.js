#!/usr/bin/env node
/* Generate PWA PNGs, screenshots, and social card from SVG sources. */
const fs = require('fs');
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  ...
  <rect x="156" y="156" width="200" height="200" rx="32" fill="${BRAND_BG}"/>
  ${columns4Mark(156, 156, 200, 18)}
</svg>`;

const maskableSvg = `<?xml version="1.0" encoding="UTF-8"?>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  <rect width="512" height="512" fill="${THEME}"/>
  <rect x="168" y="168" width="176" height="176" rx="28" fill="${BRAND_BG}"/>
  ${columns4Mark(168, 168, 176, 16)}
</svg>`;

const faviconSvg = `<?xml version="1.0" encoding="UTF-8"?>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
  <rect width="32" height="32" rx="6" fill="${THEME}"/>
  <rect x="7" y="7" width="18" height="18" rx="3" fill="${BRAND_BG}"/>
  ${columns4Mark(7, 7, 18, 1.4)}
</svg>`;
...
<svg xmlns="http://www.w3.org/2000/svg" width="1280" height="720" viewBox="0 0 1280 720">
  ...
  <rect width="1280" height="54" fill="${THEME}"/>
  <text x="640" y="35" text-anchor="middle" fill="${FG}" font-family="Tahoma, sans-serif" font-size="22" font-weight="700">LIBRUS</text>
  <text x="700" y="35" fill="${MUTED}" font-family="Tahoma, sans-serif" font-size="12">32 · r21</text>
...
<svg xmlns="http://www.w3.org/2000/svg" width="407" height="904" viewBox="0 0 407 904">
  ...
  <rect width="407" height="54" fill="${THEME}"/>
...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  <rect width="1200" height="630" fill="${THEME}"/>
  <rect x="80" y="80" width="180" height="180" rx="28" fill="${BRAND_BG}"/>
  ${columns4Mark(80, 80, 180, 10)}
